...
if (NOT DEFINED MCUXPRESSO_SDK_PACKAGE)
    message(WARNING "MCUXPRESSO_SDK_PACKAGE is not defined, to prevent SDK warning, please add definitions manually")
endif ()
...
if (cores_len EQUAL 0)
    ...
    foreach (core IN LISTS cores)
        ...
        endforeach ()
#        string(REGEX MATCH "${sdk_device}_${core}_(.*).ld" ld_file_name_match_result ${ld_files})
#        message(STATUS "ld_file_name_match_result: ${ld_file_name_match_result}")
#        if (NOT CMAKE_MATCH_COUNT EQUAL 1)
#            continue()
#        endif ()
#        if (NOT TARGET MCUXpressoSDK::Linker::${core}::${CMAKE_MATCH_1})
#            add_library(MCUXpressoSDK::Linker::${core}::${CMAKE_MATCH_1} INTERFACE IMPORTED)
#            target_link_options(MCUXpressoSDK::Linker::${core}::${CMAKE_MATCH_1} -T ${ld_files})
#        endif ()
    endforeach ()
endif ()
